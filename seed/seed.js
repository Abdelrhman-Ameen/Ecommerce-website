...
const products = [
  {
    ...
    rating: 4.9, reviewsCount: 128, featured: true, isNewArrival: true,
  },
  {
    ...
    rating: 4.8, reviewsCount: 94, featured: true, isNewArrival: true,
  },
  {
    ...
    rating: 4.7, reviewsCount: 61, featured: true,
  },
  {
    ...
    rating: 4.8, reviewsCount: 37, featured: true,
  },
  {
    ...
    rating: 4.6, reviewsCount: 45, isNewArrival: true,
  },
  {
  ...
  },
  {
    ...
    rating: 4.7, reviewsCount: 76, isNewArrival: true,
  },
  {
  ...
  },
  {
    ...
    rating: 4.8, reviewsCount: 29, featured: true,
  },
  {
  ...
  },
  {
    ...
    rating: 4.9, reviewsCount: 118, isNewArrival: true,
  },
];
...
async function seed() {
  ...
  for (const product of products) {
    await Product.findOneAndUpdate({ name: product.name }, product, { upsert: true, returnDocument: 'after', runValidators: true });
  }

  let admin = await User.findOne({ email: process.env.ADMIN_EMAIL }).select('+password');
  if (!admin) {
    admin = new User({ firstName: 'LuxeStudio', lastName: 'Admin', email: process.env.ADMIN_EMAIL, role: 'admin' });
  }
