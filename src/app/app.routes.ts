...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'support', title: 'Support — Vellora', loadComponent: () => import('./pages/support.component').then((m) => m.SupportComponent) },
  ...
  { path: 'register', canActivate: [guestGuard], title: 'Create account — Vellora', loadComponent: () => import('./pages/register.component').then((m) => m.RegisterComponent) },
  {
    ...
    children: [
      ...
      { path: 'support', title: 'Support centre — Vellora', loadComponent: () => import('./pages/admin-support.component').then((m) => m.AdminSupportComponent) },
    ],
  },
