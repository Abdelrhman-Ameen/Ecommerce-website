...
export class AdminService {
  ...
  createCategory(name: string, parent?: string): Observable<CatalogCategory> { return this.http.post<ApiResponse<{ category: CatalogCategory }>>(`${this.api}/categories`, { name, parent: parent || undefined }).pipe(map((response) => response.data.category)); }
