    ...
    <footer class="store-footer">
      <div class="container-xxl px-4 py-5">
        <div class="row g-5 py-lg-3">
          <div class="col-lg-4"><a class="brand-mark text-decoration-none" routerLink="/"><i class="bi bi-stars"></i> Ma3rad El Gamila</a><p class="footer-copy mt-3">{{ 'Wear Your Confidence' | translate }}</p><div class="d-flex gap-3 mt-4"><i class="bi bi-instagram"></i><i class="bi bi-pinterest"></i><i class="bi bi-twitter-x"></i></div></div>
