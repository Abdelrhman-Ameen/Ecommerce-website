    ...
    <footer class="store-footer">
      <div class="container-xxl px-4 py-5">
        <div class="row g-5 py-lg-3">
          <div class="col-lg-4"><a class="brand-mark text-decoration-none" routerLink="/"><i class="bi bi-stars"></i> LuxeStudio</a><p class="footer-copy mt-3">{{ 'Elevating everyday commerce through intentional design, carefully selected products, and reliable service.' | translate }}</p><div class="d-flex gap-3 mt-4"><i class="bi bi-instagram"></i><i class="bi bi-pinterest"></i><i class="bi bi-twitter-x"></i></div></div>
        ...
        <div class="footer-bottom d-flex flex-column flex-md-row justify-content-between gap-2 pt-4 mt-4"><span>© {{ year }} LuxeStudio. {{ 'All rights reserved.' | translate }}</span><span><i class="bi bi-credit-card me-3"></i><i class="bi bi-shield-check"></i></span></div>
      </div>
    </footer>
  `,
})
